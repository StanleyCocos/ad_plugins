...
extension STRadiusWidgetExtension on Widget {
  ...
  Widget border(double border, {Color? color}){
    color ??= Color(int.parse(0xEEEEEE.toString(), radix: 16));
    return Container(
      decoration: BoxDecoration(
...
extension STBorderRadiusExtension on double {
  ...
  BorderRadiusGeometry get bAll => BorderRadius.all(r);

  BorderRadiusGeometry get bBL => BorderRadius.only(bottomLeft: r);

  BorderRadiusGeometry get bTL => BorderRadius.only(topLeft: r);

  BorderRadiusGeometry get bBR => BorderRadius.only(bottomRight: r);

  BorderRadiusGeometry get bTR => BorderRadius.only(topRight: r);

  BorderRadiusGeometry get bT => BorderRadius.only(topRight: r, topLeft: r);

  BorderRadiusGeometry get bB => BorderRadius.only(bottomRight: r, bottomLeft: r);

  BorderRadiusGeometry get bL => BorderRadius.only(topLeft: r, bottomLeft: r);

  BorderRadiusGeometry get bR => BorderRadius.only(topRight: r, bottomRight: r);
}
